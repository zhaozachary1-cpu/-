(() => {
  ...
  style.textContent = `
    ...
    @media(min-width:681px){.app.company-detail-collapsed{grid-template-columns:190px minmax(0,1fr)!important}.app.company-detail-collapsed .detail{display:none!important}.app:not(.company-detail-collapsed) .calendar-event{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden}.detail-fold{position:absolute;top:13px;right:13px;z-index:2;height:30px;padding:0 10px;border:1px solid var(--line);border-radius:9px;background:#ffffff0b;color:var(--muted);font-size:10px;font-weight:700;cursor:pointer;transition:transform .16s,background .16s}.detail-fold:hover{background:#ffffff1b;color:var(--txt);transform:translateY(-1px)}}
