(() => {
  ...
  style.textContent = `
    ...
    @media (max-width:680px){
      ...
      main{order:1;gap:14px}.top{position:relative;padding:6px 2px!important;min-height:0!important;align-items:flex-start!important;gap:12px!important;flex-wrap:wrap;background:transparent!important;border:0!important;box-shadow:none!important}.top>div{padding-right:62px}.top .eyebrow{font-size:0!important}.top .eyebrow:after{content:'面试记录仪 · INTERVIEW ATLAS';font-size:9px;color:var(--cyan);letter-spacing:1px;font-weight:800}.top h1{font-size:22px!important;line-height:1.25!important;letter-spacing:-.55px}.mobile-theme-cycle{position:absolute;right:2px;top:4px;min-width:48px;height:31px;padding:0 9px;border:1px solid var(--line);border-radius:10px;background:#131d37;color:var(--muted);font-size:10px;font-weight:750;cursor:pointer}.mobile-theme-cycle:active{transform:scale(.97)}.top .primary#add{width:100%;height:52px;margin:0!important;border-radius:14px!important;font-size:14px!important;box-shadow:0 10px 23px #5265d94a}.backup-controls{order:3;width:100%;display:grid!important;grid-template-columns:1fr 1fr;gap:8px!important}.backup-button{height:38px!important;border-radius:11px!important}

      /* Four statuses are a true page-level overview, not a leftover sidebar. */
      .mobile-status-overview{order:2;display:block;padding:16px;border:1px solid var(--line);border-radius:18px;background:linear-gradient(145deg,#192441ed,#10182ded);box-shadow:0 9px 26px #0003}.mobile-section-heading{display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:13px}.mobile-section-heading span{color:var(--cyan);font-size:9px;font-weight:800;letter-spacing:1.15px}.mobile-section-heading h2{margin:4px 0 0;font-size:16px;letter-spacing:-.2px}.mobile-section-heading p{margin:0;color:var(--muted);font-size:9px}.mobile-status-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.mobile-status-card{position:relative;min-height:72px;padding:12px;border:1px solid var(--line);border-radius:13px;background:#0a132a9c;color:var(--txt);text-align:left;cursor:pointer;transition:transform .18s,border-color .18s,background .18s}.mobile-status-card:active{transform:scale(.98)}.mobile-status-card:hover{border-color:#667be1;background:#172446}.mobile-status-card i{display:inline-block;width:7px;height:7px;margin-right:5px;border-radius:50%;background:var(--cyan)}.mobile-status-card span{font-size:11px;color:var(--muted)}.mobile-status-card strong{display:block;margin-top:9px;font-size:22px;line-height:1}.mobile-status-card.pending i{background:var(--orange);box-shadow:0 0 10px #f6a35e88}.mobile-status-card.waiting i{background:#b394ff;box-shadow:0 0 10px #b394ff88}.mobile-status-card.offer i{background:var(--green);box-shadow:0 0 10px #62e3a388}.mobile-status-card.failed i{background:var(--red);box-shadow:0 0 10px #ff6d8888}
    ...
    @media (max-width:370px){.mobile-status-card{min-height:67px!important;padding:10px!important}.mobile-status-card strong{font-size:20px!important}.calendar-day{height:53px!important}.calendar-event{font-size:7px!important}.calendar-legend{font-size:8px!important}}
  `;
